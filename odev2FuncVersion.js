...
const ogrenciNotHesapla = (vizeNotlari, finalNotlari) => {
  for (let index = 0; index < vizeNotlari.length; index++) {
...
vizeOrt = toplamVize / vizeNotlari.length; 
finalOrt = toplamFinal / finalNotlari.length; 
sinifOrt = vizeOrt * 0.4 + finalOrt * 0.6; 

const harfNotuHesapla = (ogrenciNot) => {for (let index = 0; index < ogrenciNot.length; index++) {
